...
def test_PRB3103_15_login_exitoso_con_credenciales_validas(page):
    ...
    page.screenshot(path=str(EVIDENCIAS / 'PRB3103_01_inicio.png'))

    # 2. Ingresar credenciales
    page.fill('#usuario', 'analista@icg.com')
    page.fill('#password', 'Demo2026')
    page.wait_for_timeout(1000) # Pausa visual para el video
    page.screenshot(path=str(EVIDENCIAS / 'PRB3103_02_credenciales.png'))
    ...
    page.screenshot(path=str(EVIDENCIAS / 'PRB3103_03_dashboard.png'))
